...
\usepackage{array}
\usepackage[bottom]{footmisc} %Tabelle nicht unter Fußnoten
\usepackage{enumitem}
...
\usepackage[linktocpage,bookmarks,bookmarksopen={false},bookmarksnumbered,pdfstartview={FitH},
	...
	pdfsubject={Modellierung eines Risikoäquivalents für isolierte Ereignisse und singuläre Ereignisketten in Kranken- und Lebensversicherungsbiographien},
	pdfcreator={TR},
	pdfproducer={TR},
	pdfkeywords={Diplomarbeit, Tobias Riedel, Risikotheorie}]{hyperref}

%Einrücken Beginn Absatz
...
\newtheorem{nr}[defini]{Nebenrechnung}
\newenvironment{Nebenrechnung}
{\begin{nr} \ \newline}
{\end{nr}}
